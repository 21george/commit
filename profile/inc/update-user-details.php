...
<section class="content-form d-flex justify-content-center align-items-center flex-wrap">
        ...
        <div class="profile-form__styling">
            ...
            <input type="text" name="user_firstname" id="user_firstname" class="input-style" placeholder="Your Name" autocomplete="off" >
        </div>
        <div class="profile-form__styling">
            <label for="user_lastname" class="label-style">Your First Name <sup class="text-danger">Optional</sup></label>
            <input type="text" name="user_lastname" id="user_lastname" class="input-style" placeholder="Your Last Name" autocomplete="off" >
        </div>
        ...
        <div class="profile-form__styling">
            ...
            <input type="text" name="user_phone" id="user_phone" class="input-style" placeholder="Contact Number:" autocomplete="off" >
        </div>
    
        <div class="profile-form__styling">
            <label for="user_bio" class="label-style">Short Bio <sup class="text-danger">Optional</sup></label>
            <textarea style="width:40%;" rows="6" class="textarea-style" id="user_bio" name="user_bio"></textarea>
        </div>

        <div class="profile-form__styling">
            <label for="user_occupation" class="label-style">Your Occupation <sup class="text-danger">Optional</sup></label>
            <input type="text" name="user_occupation" id="user_occupation" class="input-style" placeholder="Your Occupation" autocomplete="off" >
        </div>
        <div class="profile-form__styling">
        ...
        <div class="profile-form__styling">
            ...
            <input type="text" name="user_linkedin" id="user_linkedin" class="input-style" placeholder="Your Linkedin" autocomplete="off" >
        </div>
        
        <div class="profile-form__styling">
            <label for="user_gplus" class="label-style">Your Google Plus <sup class="text-danger">Optional</sup></label>
            <input type="text" name="user_gplus" id="user_gplus" class="input-style" placeholder="Your Google Plus" autocomplete="off" >
        </div>
